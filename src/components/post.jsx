...
function Post(props) {
  ...
  return (
    <>
      <div className="flex w-[832px] h-[123px] bg-[#202024] rounded-lg justify-between items-center font-roboto">
        ...
        <div
          ...
          className="w-44 h-12 flex flex-row mr-6 items-center hover:bg-red-900 bg-red-700 rounded-lg justify-center cursor-pointer"
        >
